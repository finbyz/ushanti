...
def get_columns(filters):
	columns = [
		...
		{"label": _("BASE Amount"), "fieldname": "base_amount", "fieldtype": "Currency", "width": 140},
		{"label": _("UAN NO"), "fieldname": "uan_no", "fieldtype": "Data", "width": 180},
		{
...
def get_data(filters = {"company" : "USHANTI COLOUR CHEM LIMITED - HRD" , "month":"1" , 'year':2023} ):
	data = []
	...
	for row in data:
		...
		if get_basic:
			row.update({'uan_no':uan_no , "base_amount"  : get_basic[0].get('amount')})
	return data
