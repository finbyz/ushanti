...
class CustomBankClearance(BankClearance):
    ...
    def get_payment_entries(self):
        ...
        #FinByz Chages
        # change sql condition to get paid_amount_after_tax if it is available, if not available then paid_amount get.
        payment_entries = frappe.db.sql(
            """
            select
                "Payment Entry" as payment_document, name as payment_entry,
                reference_no as cheque_number, reference_date as cheque_date,
                if(paid_from=%(account)s and paid_amount_after_tax, paid_amount_after_tax, paid_amount) as credit,     
